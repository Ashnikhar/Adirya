...
export function Header() {
  ...
  return (
    <header className="sticky top-0 left-0 right-0 z-50 flex h-20 items-center justify-between px-4 md:px-6 bg-black/90 backdrop-blur-sm border-b border-gray-800">
